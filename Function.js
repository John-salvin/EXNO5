...
const img = ["https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.freeiconspng.com%2Fimages%2Fpear-png&psig=AOvVaw107NsEn9xlVu7IonixZSry&ust=1667569753610000&source=images&cd=vfe&ved=0CA0QjRxqFwoTCNjpocmTkvsCFQAAAAAdAAAAABAD",
...
document.getElementById("garden").innerHTML = "<img src=" + img[idx] + " height=" + h + " width=" +
w + ">"
...
document.getElementById("convertedValue").innerHTML = "Equivalent " + to + " value is " +
value.toFixed(2);
}
...
document.getElementById("cost").innerHTML = "Cake Cost: " + cakeCost + "<br>" + "Tax Cost: " + taxcost
+ "<br>" + "Tip Cost: " + tcost + "<br><br>" + "Total Cost: " + total +"₹";
}